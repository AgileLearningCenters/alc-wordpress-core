...
class CBox_Plugins {
	...
	private function register_recommended_plugins() {
		...
		if ( is_network_admin() ) :
			...
			self::register_plugin( array(
				...
				'version'           => '1.8.13',
				'download_url'      => 'http://downloads.wordpress.org/plugin/bp-groupblog.1.8.13.zip',
	...
	private function register_optional_plugins() {
		...
		self::register_plugin( array(
			...
			'version'           => '1.0-RC4',
			'depends'           => 'BuddyPress (>=1.5)',
			'download_url'      => CBOX_PLUGIN_DIR . 'includes/zip/bp-reply-by-email-1.0-RC4.zip',
	...
	private function register_dependency_plugins() {
		...
		self::register_plugin( array(
			'plugin_name'  => 'BuddyPress',
			'type'         => 'dependency',
			'download_url' => 'http://downloads.wordpress.org/plugin/buddypress.2.7.3.zip'
		) );
	}
