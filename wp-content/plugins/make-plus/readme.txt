...
* Bug fix: “-1” count option now shows all products.
* Bug fix: No longer stripping HTML from Panel item titles.
* Improved: Added checks to widgetized columns to remove a number of PHP warnings.
* Bug fix: Allow duplicator to load on any CPT Edit Page screen.
* Bug fix: Remove widgets when removing the containing section or page.
...
* Improved: Back compatibility on Columns section.

= 1.8.2 - January 10 2017 =
* Bug fix: Posts List "From" field wasn't updating when "Type" field was changed
* Bug fix: Make update notice behavior
* Bug fix: Minor fixes to `ttfmake_get_image_src` method

= 1.8.1 - January 5 2017 =
* Bug fix: Compatibility issue related to Posts List section when coming from 1.7.x

= 1.8.0 - January 4 2017 =
* Improved: Make builder sections were rewritten to support the new Make builder Backbone application.
* Improved: The new duplicator works by extending Make base view classes. Better dependency management was added to support this approach. Actual duplication now happens client-side only.
* Changed: Added a notice that Make Plus now depends on Make version 1.8.0.
...
= 1.8.4 =
Bunch of improvements and bug fixes including Columns widget areas behavior, Products, Panels, and Duplicator.

= 1.8.3 =
Improved overlay styles to match core WordPress. Added an option so builder sections can now be set to span the full width of your page.

= 1.8.2 =
Fix for Make update notice showing up when up-to-date. Bug fixes to Posts List section.

= 1.8.1 =
Bug fix for compatibility issue with Posts List when upgrading to 1.8.0 from older versions.

= 1.8.0 =
General refactor and alignment with Make 1.8.0.
