...
class MAKEPLUS_Component_PostsList_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		$defaults = array(
			'title' => '',
			'type' => ttfmake_get_section_default( 'type', 'postlist' ),
			'sortby' => ttfmake_get_section_default( 'sortby', 'postlist' ),
			'keyword' => ttfmake_get_section_default( 'keyword', 'postlist' ),
			'count' => ttfmake_get_section_default( 'count', 'postlist' ),
			'offset' => ttfmake_get_section_default( 'offset', 'postlist' ),
			'taxonomy' => ttfmake_get_section_default( 'taxonomy', 'postlist' ),
			'show-title' => ttfmake_get_section_default( 'show-title', 'postlist' ),
			'show-date' => ttfmake_get_section_default( 'show-date', 'postlist' ),
			'show-excerpt' => ttfmake_get_section_default( 'show-excerpt', 'postlist' ),
			'excerpt-length' => ttfmake_get_section_default( 'excerpt-length', 'postlist' ),
			'show-author' => ttfmake_get_section_default( 'show-author', 'postlist' ),
			'show-categories' => ttfmake_get_section_default( 'show-categories', 'postlist' ),
			'show-tags' => ttfmake_get_section_default( 'show-tags', 'postlist' ),
			'show-comments' => ttfmake_get_section_default( 'show-comments', 'postlist' ),
			'thumbnail' => ttfmake_get_section_default( 'thumbnail', 'postlist' ),
			'aspect' => ttfmake_get_section_default( 'aspect', 'postlist' ),
		);
