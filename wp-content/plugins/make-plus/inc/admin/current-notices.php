...
if ( $this->mode()->is_make_active_theme() && strcmp( $this->mode()->get_make_version(), '1.8.0' ) < 0 ) {
	$this->register_admin_notice(
		'makeplus-new-api-missing',
		__( 'The latest version of Make Plus isn’t compatible with version of Make you’re using. Please update Make.', 'make-plus' ),
		array(
			'cap'     => 'switch_themes',
			'dismiss' => false,
			'screen'  => array( 'dashboard', 'themes', 'plugins' ),
