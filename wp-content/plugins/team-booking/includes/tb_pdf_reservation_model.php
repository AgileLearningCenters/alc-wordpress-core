...
class PDF_Report extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 30, 'Reservation' . ' #' . $this->reservation->getDatabaseId(), 0, 1, 'C', TRUE);
    }
    ...
    function Footer()
    {
        ...
        $this->Cell(0, 20, 'Page' . $this->PageNo() . '/{nb}', 'T', 0, 'C');
    }
...
$pdf->MultiCell(0, 30, $reservation->getServiceName(), 0, 'C', TRUE);
$pdf->SetTextColor(0, 0, 0);

$pdf->SetY(120);

$pdf->SetFont('Arial', '', 12);
$pdf->Cell(100, 13, 'Reservation By');
...
$pdf->Cell(
    100,
    13,
    Functions\date_i18n_tb(get_option('date_format'), $reservation->getStart())
    . ' '
    . Functions\date_i18n_tb(get_option('time_format'), $reservation->getEnd()),
    0,
    1
);
...
$pdf->Ln(20);
$pdf->Write(20, "Reservation's data");
...
if ($reservation->getPrice() > 0) {
    ...
    $pdf->SetX(180);
    $pdf->SetTextColor(192, 192, 192);
    $pdf->Cell(0, 20, 'Price', 'L', 1);
    $pdf->SetFont('Arial', '', 12);
    $pdf->SetX(180);
    $pdf->SetTextColor(0, 0, 0);
    $pdf->Cell(0, 20, Functions\currencyCodeToSymbol(Functions\getSettings()->getCurrencyCode(), $reservation->getPrice(), TRUE), 'L', 1);
}
