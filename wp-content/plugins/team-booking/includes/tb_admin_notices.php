...
{
    Framework\Notice::getPositive(__('Service added succesfully!', 'team-booking'))->render();
}

function service_updated()
{
    Framework\Notice::getPositive(__('Service updated succesfully!', 'team-booking'))->render();
}

function service_deleted()
{
    Framework\Notice::getPositive(__('Service removed succesfully!', 'team-booking'))->render();
}

function services_deleted()
{
    Framework\Notice::getPositive(__('Services removed succesfully!', 'team-booking'))->render();
}
...
{
    Framework\Notice::getPositive(__('Settings deleted succesfully!', 'team-booking'))->render();
}
...
function personal_duplicated_event_title()
{
    Framework\Notice::getNegative(__('This linked event title is already used!', 'team-booking'))->render();
}
...
{
    Framework\Notice::getPositive(__('Reservation succesfully cancelled!', 'team-booking'))->render();
}

function overview_reservation_confirmed()
{
    Framework\Notice::getPositive(__('Reservation succesfully confirmed!', 'team-booking'))->render();
}
...
{
    Framework\Notice::getNegative(urldecode($_GET['generic_error']))->render();
}

function overview_logs_cleaned()
{
    Framework\Notice::getPositive(__('Error logs succesfully cleaned!', 'team-booking'))->render();
}