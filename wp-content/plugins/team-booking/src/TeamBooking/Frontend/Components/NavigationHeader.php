...
class NavigationHeader
{
        ...
        <div class="ui tbk-grid" style="margin: 0">
            <div class="tbk-row">
                ...
                <div class="ten wide tbk-column">
                    <?= \TeamBooking\Functions\tb_mb_strtoupper($text) ?>
                </div>
            </div>
        </div>
        <?php
     ...
     *
     * @param \DateTime $time_obj
     *
     * @return string
     */
    public static function InReservationForm($time_obj)
    {
        ob_start();
        ?>
        <div class="ui tbk-grid" style="margin: 0">
            <div class="tbk-row tbk-resevation-form-navigation">
                <div class="three wide tbk-column tbk-back-to tbk-back-to-slots" tabindex="0"
                     aria-label="<?= esc_html__('back to slots', 'team-booking') ?>">
                    <span class="dashicons dashicons-arrow-left-alt2"></span>
                </div>
                <div class="ten wide tbk-column tbk-schedule-date">
                    <?= \TeamBooking\Functions\date_i18n_tb(get_option('date_format'), $time_obj->getTimestamp() + $time_obj->getOffset()) ?>
                </div>
            </div>
        </div>
        <?php
            ...
            <div class="tbk-row tbk-schedule-list-navigation">
                ...
                <div class="three wide tbk-column" style="padding: 8px 0 0 0;">
                    <div class="tbk-schedule-filter-icons">
                        <?php
                        $coworkers_list = $slots->getShownCoworkerServiceIds();
