...
class fromGoogle
{
    ...
    public static function fullSyncOf($calendar_id)
    {
        ...
        while (NULL === $results['sync_token']) {
            ...
            if (!$list) return TRUE;
            if ($list instanceof \Google_Service_Exception) return $list->getCode();
            if ($list instanceof \Google_Auth_Exception) return $list->getCode();
    ...
    public function sync()
    {
        ...
        while (!empty($batch_requests)) {
            ...
            foreach ($partial_results as $id => $result) {
                /** @var $result \Google_Service_Calendar_Events */
                ...
                if ($result instanceof \Google_Service_Exception) {
                    /** @var $result \Google_Service_Exception */
     ...
     *
     * @return \Exception|\Google_Service_Calendar_Events|\Google_Service_Exception
     */
     ...
     */
    public static function reservationSync(\Google_Service_Calendar_Event $event, $calendar_id)
    {
