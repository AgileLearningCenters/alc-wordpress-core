...
class Services
{
    ...
    private function getServiceList()
    {
        ...
        foreach (\TeamBooking\Database\Services::get() as $service) {
            if (!current_user_can('manage_options') && !$user_data->isServiceAllowed($service->getId())) continue;
            ...
            $button->setHref(admin_url('admin.php?page=team-booking&tab=events&event=' . $service->getId()) . '&email=1');
            ...
            if (current_user_can('manage_options')) {
                ...
                $button->setHref(admin_url('admin.php?page=team-booking&tab=events&event=' . $service->getId()) . '&form=1');
            ...
            if (current_user_can('manage_options')) {
                ...
                $button->setHref(admin_url('admin.php?page=team-booking&tab=events&event=' . $service->getId()));
            ...
            if ($service->getClass() !== 'unscheduled') {
                ...
                $button->setHref(admin_url('admin.php?page=team-booking&tab=events&event=' . $service->getId()) . '&gcal=1');
