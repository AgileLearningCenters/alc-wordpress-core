...
class PromotionTable extends \WP_List_Table
{
    ...
    public function __construct()
    {
        ...
        $this->discount_counts = Functions\count_used_discounts($this->reservations);
    ...
    public function get_views()
    {
        ...
        $status_links = array(
            'all' => '<a href="'
                . admin_url('/admin.php?page=team-booking&tab=pricing') . '"'
        ...
        if ($this->total_promotions_campaign > 0) {
            $status_links['campaign'] = '<a href="'
                . admin_url('/admin.php?page=team-booking&tab=pricing&filter=campaign') . '"'
        ...
        if ($this->total_promotions_coupon > 0) {
            $status_links['coupon'] = '<a href="'
                . admin_url('/admin.php?page=team-booking&tab=pricing&filter=coupon') . '"'
        ...
        if ($this->total_promotions_running > 0) {
            $status_links['running'] = '<a href="'
                . admin_url('/admin.php?page=team-booking&tab=pricing&filter=running') . '"'
    ...
    protected function get_items()
    {
        ...
        foreach ($this->promotions as $db_id => $promotion) {
            ...
            $items[ $db_id ] = array(
                ...
                'start'  => \DateTime::createFromFormat('U', $promotion->getStartTime())->format(get_option('date_format'))
                    . Framework\Html::span(array(
                        'text'  => $timezone->getName(),
                        'class' => 'tbk-description'
                    )),
                'end'    => \DateTime::createFromFormat('U', $promotion->getEndTime())->format(get_option('date_format'))
                    . Framework\Html::span(array(
                        'text'  => $timezone->getName(),
                        'class' => 'tbk-description'
                    ))
    ...
    private function getEditPromotionModal(\TeamBooking\Promotions\Promotion $promotion, $id)
    {
        ...
        <ul class="tbk-list">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <?= Framework\Html::radio(array(
                                'text'    => Functions\currencyCodeToSymbol(Functions\getSettings()->getCurrencyCode(), NULL),
                                'name'    => $promotion->getName() . '-discount_type',
                                'value'   => 'direct',
            ...
            <li>
                <h4><?= esc_html__('Start date', 'team-booking') ?></h4>
                <p><?= esc_html__('The promotion will be running from this date.', 'team-booking') ?></p>
            ...
            <li>
                <h4><?= esc_html__('End date', 'team-booking') ?></h4>
                <p><?= esc_html__('The promotion will be deactivated from this date.', 'team-booking') ?></p>
                <?= Framework\Html::textfield(array(
                    'name'        => 'end_date',
                    'value'       => $end_time->format('m/d/Y'),
                    'required'    => TRUE,
                    'placeholder' => 'MM/DD/YYYY',
                    'class'       => 'tb-flatpickr',
                    'data'        => array(
                        'mindate'    => $start_time->format('m/d/Y'),
                        'dateFormat' => 'm/d/Y',
                        'altFormat'  => get_option('date_format'),
                        'altinput'   => '',
                        'allowInput' => ''
        ...
        <ul class="tbk-list">
            ...
            <li>
                ...
                <?= Framework\Html::textfield(array(
                    ...
                    'class'       => 'tb-flatpickr',
                    'data'        => array(
                        'mindate'    => $bound_start_time->format('m/d/Y'),
                        'dateFormat' => 'm/d/Y',
                        'altFormat'  => get_option('date_format'),
                        'altinput'   => '',
                        'allowInput' => ''
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px dashed lightgrey;">
                                        <span id="<?= $promotion->getName() . '-' . $service->getId() ?>-base"
                                            ...
                                            <?= Functions\currencyCodeToSymbol(Functions\getSettings()->getCurrencyCode(), $service->getPrice()) ?>
                                        </span>
                            </td>
                            <td style="border-bottom: 1px dashed lightgrey;">
                                        <span id="<?= $promotion->getName() . '-' . $service->getId() ?>-discounted"
                                              data-a-sign="<?= Functions\currencyCodeToSymbol(Functions\getSettings()->getCurrencyCode(), NULL) ?>"
