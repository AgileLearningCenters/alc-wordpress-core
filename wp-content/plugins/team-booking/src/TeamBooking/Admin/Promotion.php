...
class Promotion
{
    ...
    public function __construct()
    {
        ...
        $this->promotions = Database\Promotions::getAll();
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <?= Framework\Html::radio(array(
                                'text'  => Functions\currencyCodeToSymbol($this->settings->getCurrencyCode(), NULL),
                                'name'  => $promotion_type . '-discount_type',
                                'value' => 'direct'
                            )) ?>
                        </td>
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px dashed lightgrey;">
                                        <span id="<?= $promotion_type . '-' . $service->getId() ?>-base"
                                            ...
                                            <?= Functions\currencyCodeToSymbol($this->settings->getCurrencyCode(), $service->getPrice()) ?>
                                        </span>
                            </td>
                            <td style="border-bottom: 1px dashed lightgrey;">
                                        <span id="<?= $promotion_type . '-' . $service->getId() ?>-discounted"
                                              data-a-sign="<?= Functions\currencyCodeToSymbol($this->settings->getCurrencyCode(), NULL) ?>"
