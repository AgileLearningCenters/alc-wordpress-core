...
class Customers
{
    ...
    public function __construct()
    {
        ...
        $this->reservations = Database\Reservations::getAll();
        $this->wp_users = get_users();
        ...
        foreach ($sorted_reservations as $customer_id => $data) {
        ...
        foreach ($this->customers as $customer) {
            ...
            foreach ($customer->getReservations() as $service_id => $reservation_number) {
                ...
                $table_modal->addRow(array(
                    0 => $service->getName() . $service_label . $reset_label,
