...
class Modal implements Element
{
    ...
    {
        echo '<div class="ui small modal tbk-modal'
        ...
        echo '<div class="header">' . esc_html($this->header_text['main']);
        if (!empty($this->header_text['sub'])) {
            echo ' <div class="sub header">'
                . ($this->header_text['sub'] instanceof Element ? $this->header_text['sub']->get() : esc_html($this->header_text['sub']))
                . '</div>';
        }
        echo '</div>';
        if (!empty($this->tabs)) {
